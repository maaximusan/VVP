...
<?php if(thegem_get_option('page_layout_style') == 'body-frame') : ?>
	<?php if(!empty(thegem_get_option('page_padding_mobile_activate'))) : ?>
	<?php if(thegem_get_option('page_padding_mobile_top')) : ?>
	#page {
		margin-top: <?php echo thegem_get_option('page_padding_mobile_top'); ?>px;
	}
	<?php endif; ?>
	<?php if(thegem_get_option('page_padding_mobile_bottom')) : ?>
	#page {
		margin-bottom: <?php echo thegem_get_option('page_padding_mobile_bottom'); ?>px;
	}
	<?php endif; ?>
	<?php if(thegem_get_option('page_padding_mobile_left')) : ?>
	#page {
		margin-left: <?php echo thegem_get_option('page_padding_mobile_left'); ?>px;
	}
	#site-header.shrink.fixed .container-fullwidth {
		padding-left: <?php echo thegem_get_option('page_padding_mobile_left')+21; ?>px;
	}
	#site-header.header-sticked .header-wrapper {
		padding-left: <?php echo thegem_get_option('page_padding_mobile_left'); ?>px;
	}
	<?php endif; ?>
	<?php if(thegem_get_option('page_padding_mobile_right')) : ?>
	#page,
	.scroll-top-button {
		margin-right: <?php echo thegem_get_option('page_padding_mobile_right'); ?>px;
	}
	#site-header.shrink.fixed .container-fullwidth {
		padding-right: <?php echo thegem_get_option('page_padding_mobile_right')+21; ?>px;
	}
	#site-header.header-sticked .header-wrapper {
		padding-right: <?php echo thegem_get_option('page_padding_mobile_right'); ?>px;
	}
	<?php endif; ?>
	<?php endif; ?>

	<?php if(!empty(thegem_get_option('page_padding_tablet_activate'))) : ?>
	@media (min-width: 768px) {
	<?php if(thegem_get_option('page_padding_tablet_top')) : ?>
	#page {
		margin-top: <?php echo thegem_get_option('page_padding_tablet_top'); ?>px;
	}
	<?php endif; ?>
	<?php if(thegem_get_option('page_padding_tablet_bottom')) : ?>
	#page {
		margin-bottom: <?php echo thegem_get_option('page_padding_tablet_bottom'); ?>px;
	}
	<?php endif; ?>
	<?php if(thegem_get_option('page_padding_tablet_left')) : ?>
	#page {
		margin-left: <?php echo thegem_get_option('page_padding_tablet_left'); ?>px;
	}
	#site-header.shrink.fixed .container-fullwidth {
		padding-left: <?php echo thegem_get_option('page_padding_tablet_left')+21; ?>px;
	}
	#site-header.header-sticked .header-wrapper {
		padding-left: <?php echo thegem_get_option('page_padding_tablet_left'); ?>px;
	}
	<?php endif; ?>
	<?php if(thegem_get_option('page_padding_tablet_right')) : ?>
	#page,
	.scroll-top-button {
		margin-right: <?php echo thegem_get_option('page_padding_tablet_right'); ?>px;
	}
	#site-header.shrink.fixed .container-fullwidth {
		padding-right: <?php echo thegem_get_option('page_padding_tablet_right')+21; ?>px;
	}
	#site-header.header-sticked .header-wrapper {
		padding-right: <?php echo thegem_get_option('page_padding_tablet_right'); ?>px;
	}
	<?php endif; ?>
	}
	<?php endif; ?>
...
<?php if(thegem_get_option('mobile_menu_global_section_background_color')) : ?>
:root {
	--thegem-to-mobile-menu-global-section-bg-color: <?php echo thegem_get_option('mobile_menu_global_section_background_color'); ?>;
}
<?php endif; ?>
...
<?php if (!thegem_get_option('disable_scroll_top_button') && thegem_get_option('enable_scroll_top_button_customize')) : ?>
<?php if (thegem_get_option('scroll_top_button_icon') && thegem_get_option('scroll_top_button_icon_pack')) : ?>
:root {
	--thegem-scroll-top-button-icon-pack: '<?php echo thegem_get_contact_font_family(thegem_get_option('scroll_top_button_icon_pack')); ?>';
	--thegem-scroll-top-button-icon: '\<?php echo thegem_get_option('scroll_top_button_icon'); ?>';
}
<?php endif; ?>
<?php if (thegem_get_option('scroll_top_button_size')) : ?>
:root {
	--thegem-scroll-top-button-size: <?php echo thegem_get_option('scroll_top_button_size'); ?>px;
}
<?php endif; ?>
<?php if (thegem_get_option('scroll_top_button_icon_size')) : ?>
:root {
	--thegem-scroll-top-button-icon-size: <?php echo thegem_get_option('scroll_top_button_icon_size'); ?>px;
}
<?php endif; ?>
<?php if (thegem_get_option('scroll_top_button_right') || thegem_get_option('scroll_top_button_right') === '0') : ?>
:root {
	--thegem-scroll-top-button-right: <?php echo thegem_get_option('scroll_top_button_right'); ?>px;
}
<?php endif; ?>
<?php if (thegem_get_option('scroll_top_button_bottom') || thegem_get_option('scroll_top_button_bottom') === '0') : ?>
:root {
	--thegem-scroll-top-button-bottom: <?php echo thegem_get_option('scroll_top_button_bottom'); ?>px;
}
<?php endif; ?>
<?php if (thegem_get_option('scroll_top_button_background_color')) : ?>
:root {
	--thegem-scroll-top-button-background-color: <?php echo thegem_get_option('scroll_top_button_background_color'); ?>;
}
<?php endif; ?>
<?php if (thegem_get_option('scroll_top_button_hover_background_color')) : ?>
:root {
	--thegem-scroll-top-button-hover-background-color: <?php echo thegem_get_option('scroll_top_button_hover_background_color'); ?>;
}
<?php endif; ?>
<?php if (thegem_get_option('scroll_top_button_arrow_color')) : ?>
:root {
	--thegem-scroll-top-button-arrow-color: <?php echo thegem_get_option('scroll_top_button_arrow_color'); ?>;
}
<?php endif; ?>
<?php if (thegem_get_option('scroll_top_button_hover_arrow_color')) : ?>
:root {
	--thegem-scroll-top-button-hover-arrow-color: <?php echo thegem_get_option('scroll_top_button_hover_arrow_color'); ?>;
}
<?php endif; ?>
<?php if (thegem_get_option('scroll_top_button_border')) : ?>
:root {
	--thegem-scroll-top-button-border: <?php echo thegem_get_option('scroll_top_button_border'); ?>px;
	--thegem-scroll-top-button-border-style: solid;
<?php if (thegem_get_option('scroll_top_button_border_color')) : ?>
	--thegem-scroll-top-button-border-color: <?php echo thegem_get_option('scroll_top_button_border_color'); ?>;
<?php endif; ?>
<?php if (thegem_get_option('scroll_top_button_hover_border_color')) : ?>
	--thegem-scroll-top-button-hover-border-color: <?php echo thegem_get_option('scroll_top_button_hover_border_color'); ?>;
<?php endif; ?>
}
<?php endif; ?>
<?php if (thegem_get_option('scroll_top_button_corner')) : ?>
:root {
	--thegem-scroll-top-button-border-radius: <?php echo thegem_get_option('scroll_top_button_corner'); ?>px;
}
<?php endif; ?>
<?php endif; ?>

<?php if(thegem_get_option('submenu_indicator_spacing') !== '') : ?>
:root {
	--thegem-submenu-indicator-spacing: <?php echo intval(thegem_get_option('submenu_indicator_spacing')); ?>px;
}
<?php endif; ?>

<?php if (thegem_get_option('custom_container_width_enable')) : ?>
@media (min-width: 1212px) {
	.container {
		width: 100%;
		max-width: max(1212px, calc(<?php echo thegem_container_width_value(); ?> + 42px));
	}
	...
	.fullwidth-content .elementor-container.elementor-column-gap-thegem .elementor-inner-section.elementor-section-boxed .elementor-container.elementor-column-gap-thegem {
		max-width: max(1170px, <?php echo thegem_container_width_value(); ?>);
	}
	.e-con.thegem-e-con-layout-thegem {
		--container-max-width: max(1170px, <?php echo thegem_container_width_value(); ?>);
		--content-width: max(1170px, <?php echo thegem_container_width_value(); ?>);
	}
	.e-con.thegem-e-con-layout-thegem:has(> .e-con),
	.e-con.thegem-e-con-layout-thegem:has(> .e-con-inner > .e-con) {
		--container-max-width: max(1212px, calc(<?php echo thegem_container_width_value(); ?> + 42px));
		--content-width: max(1212px, calc(<?php echo thegem_container_width_value(); ?> + 42px));
	}
}
<?php endif; ?>

<?php if (thegem_get_option('scrollbar_gutter_stability')) : ?>
