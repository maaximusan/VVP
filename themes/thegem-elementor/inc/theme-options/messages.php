...
return array(
    ...
    'info' => array (
        ...
        'container_width_settings' => __('When activated, this setting allows you to specify a custom width for all content areas, including the header, title area, main content area, and footer. Default: 1170px.', 'thegem'),
        ...
        'header_content_offcanvas_area' => sprintf(__('<p>Select the content source for the off-canvas content area which appears after clicking on hamburger toggle. You can choose between the top primary menu as set in "Appearance - Menus" and <a href="%s" target="_blank">global section template</a>.</p>', 'thegem'), 'https://docs.codex-themes.com/article/237-general'),
        ...
        'website_search_post_types_product_variation' => __('Enable to include product variations in search results.', 'thegem'),
        'website_search_mixed_disabled' => __('Enable/disable intermediate page with mixed search results, separated by post types.', 'thegem'),
        ...
        'title_area_general_excerpt' => __('Enable or disable the display of page/post excerpt in the title area. You can also turn on or off the excerpt in the title area for individual post types and individual posts/pages separately.', 'thegem'),
        ...
        'team_persons_page_enable' => __('By activating this option the team persons will have separate single pages and teams will have separate archive pages', 'thegem'),
        'team_persons_page_rewrite_slug_1' => __('<p>Here you can define your own slug to appear as part of team person\'s URL. By default /team-person/ is used.</p><p><b>IMPORTANT:</b> after changing this slugs, please visit </p>', 'thegem'),
        'team_persons_page_rewrite_slug_2' => __('"Permalink Settings"','thegem'),
        'team_persons_page_rewrite_slug_3' => __('page and click on "Save changes".','thegem'),

        'portfolio_category_page_enable' => __('By activating this option the portfolio categories will have separate archive pages', 'thegem'),
        'portfolio_category_page_rewrite_slug_1' => __('<p>Here you can define your own slug to appear as part of team person\'s URL. By default /portfolio/ is used.</p><p><b>IMPORTANT:</b> after changing this slugs, please visit </p>', 'thegem'),
        'portfolio_category_page_rewrite_slug_2' => __('"Permalink Settings"','thegem'),
        'portfolio_category_page_rewrite_slug_3' => __('page and click on "Save changes".','thegem'),
        ...
        'single_pages_portfolio_rewrite_slug_cats' => __('If enabled, the URLs of the portfolio items will include portfolio categories','thegem'),
        ...
        'testimonials_custom_fields_add' => __('<p>By default each testimonial has a set of built-in fields like "Name", "Company", "Position", "Link". Here you can add new additional custom fields, which you can then use in <a href="https://docs.codex-themes.com/article/656-video-tutorial-loop-item-builder" target="_blank">Loop Item Builder</a> via "Custom Fields" element to display additional testimonial information</p>', 'thegem'),
        'team_persons_custom_fields_add' => __('<p>By default each testimonial has a set of built-in fields like "Name", "Position", "Phone", "Email", "Link". Here you can add new additional custom fields, which you can then use in <a href="https://docs.codex-themes.com/article/656-video-tutorial-loop-item-builder" target="_blank">Loop Item Builder</a> via "Custom Fields" element to display additional testimonial information</p>', 'thegem'),
        ...
        'woocommerce_term_product_page_layout_source_po' => __('<p>TheGem includes flexible <b>built-in settings</b> for single product page layout with many configuration options (located in <a href="'.get_site_url().'/wp-admin/admin.php?page=thegem-theme-options#/woocommerce/product-layout" target="_blank">Theme Options -> WooCommerce -> Product</a>) as well as <b>single product builder</b>, allowing you to create product page templates with page builder. Here you can specify, which type of layout settings to use for all products of this taxonomy term.</p>', 'thegem'),
        ...
        'woocommerce_product_gallery_thumb_scroll_by_hover' => __('Activate to scroll product thumbnails in product gallery by first/last item hover.', 'thegem'),
        'woocommerce_product_gallery_thumb_count' => __('Specify the number of product thumbnails to be displayed on desktop.', 'thegem'),
        ...
        'woocommerce_product_archive_show_reviews_count' => __('Show/hide reviews count in a product in the shop grid.', 'thegem'),
        ...
        'woocommerce_cart_checkout_mini_cart_global_section' => sprintf(__('<p>By activating this option, you can display a global section template in your minicart. You can select which template to display, as well as its position within the minicart. You can create new global section templates in the <a href="%s" target="_blank">Templates Builder -> Global Sections.</a></p>', 'thegem'), admin_url('edit.php?post_type=thegem_templates&templates_type=content')),
        'woocommerce_cart_checkout_mini_cart_empty_global_section' => sprintf(__('<p>By activating this option, you can display a global section template in your off-canvas empty minicart. You can create new global section templates in the<br><a href="%s" target="_blank">Templates Builder -> Global Sections.</a></p>', 'thegem'), admin_url('edit.php?post_type=thegem_templates&templates_type=content')),
        ...
        'performance_page_speed_products_attributes_count_cache_disable' => __('By default, WooCommerce caches the number of products per attribute or term using transients when you use sidebar filters. However, if your shop uses many attributes or terms, these transients can become very large, potentially exceeding MySQL\'s record size limit. This can cause performance issues and increase server error logs. To avoid this, you can disable the transient cache for product attribute counts.', 'thegem'),
        'performance_page_speed_products_attributes_count_cache_size' => __('Set the maximum size (in MB) for transient cache storage. If the cache exceeds this limit, it will be automatically reduced by half to prevent performance issues. Adjust this value based on your server\'s capacity and performance needs. Leave blank for no limitations (default state).', 'thegem'),
        ...
        'extras_scrollbar_gutter_stability' => __('Prevents content layout shift on page load when the scrollbar appears by reserving space for it', 'thegem'),
        ...
        'extras_rtl_improved' => __('<p>Improved styles for RTL websites</p>', 'thegem'),
        ...
        'p_options_term_post_layout_settings' => __('<p><b>Default Settings:</b> inherit single post content layout settings for all posts of this taxonomy term from Theme Options.<br/><br/><b>Custom Settings:</b> apply individual single post content layout settings for all posts of this taxonomy term.</p>', 'thegem'),
        ...
        'p_options_term_post_layout_source_custom' => __('<p>Select <b>"Built-In Layout"</b> to apply built-in single post layout to all posts of this taxonomy term.<br/><br/>Select <b>"Templates Builder"</b> to apply selected single post template made in <a href="'.get_site_url().'/wp-admin/edit.php?post_type=thegem_templates&templates_type=single-post" target="_blank">Templates Builder</a> to all posts of this taxonomy term.</p>', 'thegem'),
        ...
        'p_options_term_product_layout_settings' => __('<p><b>Default Settings:</b> inherit single product content layout settings for all products of this taxonomy term from Theme Options.<br/><b>Custom Settings:</b> apply individual single product content layout settings for all products of this taxonomy term.</p>', 'thegem'),
    ...
    'menu' => array(
        ...
        'posttypes_team_persons' => __('Team Persons', 'thegem'),
        ...
        'product-layout-single' => __('Single Products Layout', 'thegem'),
    ),
    'apply' => array (
    ...
    'panel' => array(
        ...
        'scroll_top_button_customize' => __('Customize «Scroll to Top» Button', 'thegem'),
        'scroll_top_button_styles' => __('Button Styles', 'thegem'),
        ...
        'products_attributes_count_cache_disable' => __('Products attributes count transient cache', 'thegem'),
        'products_attributes_count_cache_size' => __('Max. size of transient cache', 'thegem'),
        ...
        'container_width' => __('Custom Content Width', 'thegem'),
        ...
        'scrollbar_gutter_stability' => __('Scrollbar Gutter Stability', 'thegem'),
        ...
        'rtl_improved' => __('Improved RTL', 'thegem'),
        ...
        'team_persons_page' => __('Team Person Page', 'thegem'),
        'team_persons_page_enable' => __('Enable Team Person Page', 'thegem'),
        'portfolio_category_page' => __('Portfolio Category Page', 'thegem'),
        'portfolio_category_page_enable' => __('Enable Portfolio Archive Page', 'thegem'),
        'portfolio_parent_page' => __('Parent Page for Portfolio Items', 'thegem'),
        'rewrite_slug' => __('Rewrite Slug', 'thegem'),
        'rewrite_slug_cats' => __('Category Base', 'thegem'),
        ...
        'fullpage_dots_color' => __('Navigation Dots Color', 'thegem'),
        'fullpage_dots_tolltips_text_color' => __('Tooltips Text Color', 'thegem'),
        'fullpage_dots_tolltips_bg_color' => __('Tooltips Background Color', 'thegem'),
        ...
        'fullpage_footer_anchor' => __('Footer Slide Anchor', 'thegem'),
        'fullpage_footer_name' => __('Footer Slide Name', 'thegem'),
        ...
        'product_gallery_thumb_scroll_by_hover' => __('Scroll Thumbnails by Hover', 'thegem'),
        'product_gallery_thumb_count' => __('Number of thumbnails', 'thegem'),
        ...
        'product_archive_truncate_title' => __('Truncate Title (Lines)', 'thegem'),
        ...
        'product_archive_show_reviews_count' => __('Reviews Count', 'thegem'),
        ...
        'website_search_post_types_product_variation' => __('Include Product Variations', 'thegem'),
        'website_search_mixed_disabled' => __('Mixed Search Results Page', 'thegem'),
        ...
        'mini_cart_global_section' => __('Global Section in Minicart', 'thegem'),
        'mini_cart_empty_global_section' => __('Global Section in Offcanvas Empty Minicart', 'thegem'),
        'popups' => __('Popups', 'thegem'),
    ...
    'settings' => array(
        ...
        'show_title_area_excerpt' => __('Show Excerpt in Title Area', 'thegem'),
        'custom_container_width' => __('Value', 'thegem'),
        'custom_container_width_units' => __('Units', 'thegem'),
        'custom_container_width_css' => __('CSS Value', 'thegem'),
        'horizontal' => __('Horizontal', 'thegem'),
        'vertical' => __('Vertical', 'thegem'),
        'title_top_margin' => __('Title Top Margin', 'thegem'),
        'title_max_width' => __('Title Max Width', 'thegem'),
        ...
        'select_icon' => __('Select icon', 'thegem'),
        'offset_right' => __('Offset right', 'thegem'),
        'offset_bottom' => __('Offset bottom', 'thegem'),
    ),
    'addicon' => array(
    ...
    'headerLayout' => array(
        ...
        'select_template_global_section' => __('Select Template (Global Section)', 'thegem'),
        'submenu_indicator' => __('Submenu Indicator', 'thegem'),
        'submenu_indicator_spacing' => __('Spacing', 'thegem'),
    ),
    'logo' => array(
    ...
    'colors' => array(
        ...
        'mobile_menu_global_section_background_color' => __('Mobile Navigation Area Background', 'thegem'),
    ...
    'alert' => array(
        ...
        'mobile_menu_global_section_background_color' => __('Specify the background color for the mobile navigation panel', 'thegem'),
        'mobile_menu_global_section_info' => sprintf(__('You can use global section template to display your mobile navigation by selecting global section below. <a href="%s" target="_blank">Learn more</a>', 'thegem'), 'https://docs.codex-themes.com/category/714-mobile-navigation-builder'),
    ...
    'cartCheckout' => array(
        ...
        'mini_cart_global_section_position' => __('Position', 'thegem'),
        'mini_cart_global_section_position_none' => __('None', 'thegem'),
        'mini_cart_global_section_position_bmt' => __('Before minicart table', 'thegem'),
        'mini_cart_global_section_position_amt' => __('After minicart table', 'thegem'),
        'mini_cart_global_section_position_act' => __('After cart totals', 'thegem'),
        'mini_cart_global_section_position_acb' => __('After checkout buttons', 'thegem'),
    ),
    'search' => array(
