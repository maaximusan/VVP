...
<?php if ($isProduct && !$params['isLegacy']): ?>
	<div class="socials-sharing socials socials-colored-hover">
		...
		<?php if ($params['isTumblr']): ?>
			<a class="socials-item" target="_blank" href="<?php echo esc_url('https://www.tumblr.com/widgets/share/tool?canonicalUrl='.urlencode(get_permalink())); ?>" title="Tumblr"><i class="socials-item-icon tumblr"></i></a>
		<?php endif; ?>
